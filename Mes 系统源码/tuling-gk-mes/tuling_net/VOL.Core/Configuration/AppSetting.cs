...
namespace VOL.Core.Configuration
{
    public static class AppSetting
    {
        ...
        {
            get { return SqlSugarConnections[0].ConnectionString; }
        }
        ...
        public static bool UseCoreStorage
        {
            get { return _connection.UseCoreStorage; }
        }
        ...
        public static bool UseSqlLog
        {
            get { return _connection.UseSqlLog; }
        }
        ...
        public static List<SqlSugarConnection> SqlSugarConnections { get; private set; }
        ...
        /// ChatGpt配置
        /// </summary>
        public static ChatGptInfo ChatGptInfo { get; set; }
        ...
        public static void Init(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.Configure<List<SqlSugarConnection>>(configuration.GetSection("SqlSugarConnections"));
            ...
            services.Configure<ChatGptInfo>(configuration.GetSection("ChatGptInfo"));
            ...
            ChatGptInfo = provider.GetRequiredService<IOptions<ChatGptInfo>>().Value;

            _connection = provider.GetRequiredService<IOptions<Connection>>().Value;

            SqlSugarConnections = provider.GetRequiredService<IOptions<List<SqlSugarConnection>>>().Value;

            ExpMinutes = (configuration["ExpMinutes"] ?? "120").GetInt();

            DBType.Name = SqlSugarConnections[0].DBType.ToString();
            if (string.IsNullOrEmpty(SqlSugarConnections[0].ConnectionString))
                throw new System.Exception("未配置好数据库默认连接");

            try
            {
                SqlSugarConnections[0].ConnectionString = SqlSugarConnections[0].ConnectionString.DecryptDES(Secret.DB);
            }
            catch { }
    ...
    public class Connection
    {
        ...
        public bool UseCoreStorage { get; set; }
    }
