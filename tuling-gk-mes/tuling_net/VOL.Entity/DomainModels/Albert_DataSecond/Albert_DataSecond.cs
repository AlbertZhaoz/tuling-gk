...
{
    [Entity(TableCnName = "环形2线", TableName = "Albert_DataSecond")]
    public partial class Albert_DataSecond : BaseEntity
    {
        /// <summary>
        ///数据主键
        /// </summary>
        ...
        ///Op330标签码
        /// </summary>
        [Display(Name = "Op330标签码")]
        [MaxLength(50)]
        [Column(TypeName = "nvarchar(50)")]
        public string Op330LabelNo { get; set; }
