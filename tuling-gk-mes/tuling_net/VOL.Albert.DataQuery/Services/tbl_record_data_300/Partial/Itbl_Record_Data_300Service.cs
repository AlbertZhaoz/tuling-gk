/*
 *所有关于tbl_record_data_300_view类的业务代码应在此处编写
*可使用repository.调用常用方法，获取EF/Dapper等信息
*如果需要事务请使用repository.DbContextBeginTransaction
*也可使用DBServerProvider.手动获取数据库相关信息
*用户信息、权限、角色等使用UserContext.Current操作
*tbl_record_data_300_viewService对增、删、改查、导入、导出、审核业务代码扩展参照ServiceFunFilter
*/
...
{
    public partial class Itbl_Record_Data_300Service
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly Itbl_record_data_300Repository _repository;//访问数据库
        private WebResponseContent _responseContent = new();

        [ActivatorUtilitiesConstructor]
        public Itbl_Record_Data_300Service(
            Itbl_record_data_300Repository dbRepository,
        ...
        public override PageGridData<tbl_record_data_300> GetPageData(PageDataOptions options)
        {
            var pageGridData = new PageGridData<tbl_record_data_300>();
            int totalCount = 0;
